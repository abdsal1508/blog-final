...
$search_query = '';
$category_id = '';
$options = array('status' => 'published');
...
$featured_post = $postService->getFeaturedPost();
        ...
        <div class="card mb-4 shadow-lg">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-2 category-filter">
                    <a href="index.php" class="filter-btn <?php echo empty($category_id) ? 'active' : ''; ?>">
                        All Posts
                    </a>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 shadow-lg blog-post">
                            ...
                            <div class="card-body d-flex flex-column post-content-wrapper">
                                <div class="mb-2">
                                    <span class="badge heading-for category-badge"><?php echo html_escape($post['category_name']); ?></span>
                                    <span class="text-muted ms-2"><i class="fas fa-calendar-alt me-1"></i>
                                ...
                                <div class="mt-auto">
                                    ...
                                    <a href="view_post.php?id=<?php echo $post['post_id']; ?>" class="btn manual-button btn-sm read-more">
                                        Read More
                                    </a>
                                </div>
                            </div>
    ...
    <div class="col-lg-4">
        <div class="card mb-4 shadow-lg sidebar-card">
            ...
            <div class="card-body sidebar-body">
                <p>Welcome to our Blog Management System. Here you can find the latest articles from our authors on various topics.</p>
                <?php if (!is_logged_in()): ?>
                    <p>Want to contribute? <a href="../auth/login.php">Login</a> or <a href="../auth/signup.php">Sign up</a> to get started!</p>
                <?php elseif (is_author() || is_admin()): ?>
                    <p>You're logged in as an author. <a href="../dashboard/user_dashboard.php">Write a post</a> in your dashboard!</p>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="card-body sidebar-body">
                <div class="popular-tags">
                    <?php foreach ($popular_categories as $category): ?>
                        <a href="index.php?category=<?php echo $category['category_id']; ?>" class="tag">
